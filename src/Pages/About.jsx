...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Enhancing visuals with creative video craftsmanship
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
...
const ProfileImage = memo(() => (
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 pt-0">
    <div 
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Currently studying (BIM) Bachelors in Information Management, I continue to deepen my understanding of technology and digital systems while enhancing my skills in crafting user-focused digital solutions. Alongside my studies, I am also passionate about video editing, where I transform raw footage into creative and engaging visual stories.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging video editing as a craft to elevate stories, not overshadow them."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/15m3fytEXddhN59zwNj6euS_T2ek3BmBq/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
